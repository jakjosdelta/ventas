...
<?php
 class clase_mysql{
	...
	function verconsulta3(){
 	...
 	function listar2(){
 		echo "<table id='example111' class='display'>
	 		<thead>
		        <tr>
		            <th></th>
		            <th></th>
	 			...
	 			if ($tr==1) {
	 				echo "<tr>";
	 					echo "<td>
		            		<div>
		                        <div class='thumbnail'>
		                            <img class='img-thumbnail' src='".$row['imagen']."'>
		                            <div class='caption'>
		                                <h4 class'pull-right'>".$row['precio']."</h4>
		                                <h4><a href='#'>".$row['nombre']."</a>
		                                </h4>
		                                <p>".substr(utf8_encode($row['descripcion']),0,20)."</p>
		                            </div>
		            		...
		            		<div>
		                        <div class='thumbnail'>
		                            ...
		                            <div class='caption'>
		                                ...
		                                <p>".substr(utf8_encode($row['descripcion']),0,50)."</p>
		                            </div>
